...
const numberToText_EN = (number) => {
    ...
    return number < 20 ?
        single[number] :
        number < 100 ?
        tens[trunc(number / 10) * 10] + (number - trunc(number / 10) * 10 > 0 ? " " + numberToText_EN(number - trunc(number / 10) * 10) : '') :
        number < 1000 ?
        single[trunc(number / 100)] + " hundred " + numberToText_EN(number - trunc(number / 100) * 100) :
        number < 1000000 ?
        numberToText_EN(trunc(number / 1000)) + " thousand " + numberToText_EN(number - trunc(number / 1000) * 1000) :
        number < 1000000000 ?
        numberToText_EN(trunc(number / 1000000)) + " million " + numberToText_EN(number - trunc(number / 1000000) * 1000000) :
        number < 1000000000000 ?
